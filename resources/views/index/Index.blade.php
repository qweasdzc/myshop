    ...
    <div class="marginB" id="loadingPicBlock">
        ...
        <div class="success-tip">
        	...
        	<ul class="right-con">
				...
				<li>
					<span style="color: #4E555E;">
						<a href="./index.php?i=107&amp;c=entry&amp;id=10&amp;do=notice&amp;m=weliam_indiana" style="color: #4E555E;">恭喜<span class="username">嗷嗷嗷</span>获得了<span>iphone7 红色 128G 闪耀你的眼</span></a>
					</span>
				</li>
				<li>
					<span style="color: #4E555E;">
						<a href="./index.php?i=107&amp;c=entry&amp;id=10&amp;do=notice&amp;m=weliam_indiana" style="color: #4E555E;">恭喜<span class="username">打打打</span>获得了<span>iphone7 红色 128G 闪耀你的眼</span></a>
					</span>
				</li>
			</ul>
        </div>
        ...
        <div class="endtime">
        	<ul class="endtime-list clearfix">
        		<li>
        			<a href="" class="endtime-img"><img src="/index/images/goods1.jpg" alt=""></a>
        			<p>倒计时</p>
        			<div class="pro-state">			
            ...
            <ul id="ulGoodsList" class="goods-list clearfix">
            	...
            	<li id="23558" codeid="12751965" goodsid="23558" codeperiod="28436">
            		<a href="/shopcontent/{{$v->goods_id}}" class="g-pic">
            			<img class="lazy" name="goodsImg" data-original="{{$v->goods_logo}}" width="136" height="136">
            		</a>
            		<p class="g-name"><a href="/shopcontent/{{$v->goods_id}}">{{$v->goods_name}}</a></p>
            		<ins class="gray9">
                        价值：￥{{$v->goods_price}}<br>
                        库存：{{$v->goods_num}}
                    </ins>
            		...
            		<div class="btn-wrap" name="buyBox" limitbuy="0" surplus="58" totalnum="1625" alreadybuy="1567">
            			<a href="/shopcontent/{{$v->goods_id}}" class="buy-btn" codeid="12751965">立即潮购</a>
...
<div id="div_fastnav" class="fast-nav-wrapper">
    ...
    <div class="sub-nav four" style="display: none;">
        <a href="zhuce"><i class="shopcar"></i>账号注册</a>
        <a href="logins"><i class="shopcar"></i>登录</a>
        <a href="#"><i class="announced"></i>最新揭晓</a>
        <a href="#"><i class="single"></i>晒单</a>
        <a href="#"><i class="personal"></i>我的潮购</a>
        <a href="gowuche"><i class="shopcar"></i>购物车</a>
    </div>
</div>
...
<script src="/index/js/lazyload.min.js"></script>
<script>
   
        jQuery(document).ready(function() {
            $("img.lazy").lazyload({
                placeholder : "/index/images/loading2.gif",
                effect: "fadeIn",
            });
